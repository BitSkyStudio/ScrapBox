...
public class RenderData {
    ...
    public void draw(Batch batch, ClientGameObject gameObject){
        ...
        float widthScale = configScalingW?gameObject.config.size:1;
        float heightScale = configScalingH?gameObject.config.size:1;
        if(this.materialTexture != null){
            Color color = gameObject.config.material.color;
