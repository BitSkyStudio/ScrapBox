...
public class InGameScene implements IScene {
    ...
    public void create() {
        ...
        this.toolBox.addPart("frame", renderDataRegistry.get("frame"), FrameGameObject::getItemCost, true, null);
        this.toolBox.addPart("wheel", renderDataRegistry.get("wheel"), SimpleWheelGameObject::getItemCost, true, "size");
        this.toolBox.addPart("sticky_wheel", renderDataRegistry.get("sticky_wheel"), StickyWheelGameObject::getItemCost, true, "size");
        this.toolBox.addPart("cutting_wheel", renderDataRegistry.get("cutting_wheel"), CuttingWheelGameObject::getItemCost, true, "size");
        this.toolBox.addPart("motor", renderDataRegistry.get("motor"), MotorGameObject::getItemCost, false, null);
        this.toolBox.addPart("triangle", renderDataRegistry.get("triangle"), TriangleGameObject::getItemCost, false, "angle");
        this.toolBox.addPart("balloon", renderDataRegistry.get("balloon"), BalloonGameObject::getItemCost, false, null);
        this.toolBox.addPart("controller", renderDataRegistry.get("controller"), ControllerGameObject::getItemCost, false, null);
        this.toolBox.addPart("puncher", renderDataRegistry.get("puncher_box"), PunchBoxGameObject::getItemCost, false, null);
        this.toolBox.addPart("propeller", renderDataRegistry.get("propeller"), PropellerGameObject::getItemCost, false, null);
        this.toolBox.addPart("tnt", renderDataRegistry.get("tnt"), TntGameObject::getItemCost, false, null);
        this.toolBox.addPart("rotator", renderDataRegistry.get("rotator_join"), RotatorGameObject::getItemCost, false, null);
        this.toolBox.addPart("cannon", renderDataRegistry.get("cannon"), CannonGameObject::getItemCost, false, null);
        this.toolBox.addPart("position_sensor", renderDataRegistry.get("position_sensor"), PositionSensorGameObject::getItemCost, false, null);
        this.toolBox.addPart("display", renderDataRegistry.get("display"), DisplayGameObject::getItemCost, false, null);
        this.toolBox.addPart("math_unit", renderDataRegistry.get("math_unit"), MathUnitGameObject::getItemCost, false, null);
        this.toolBox.addPart("chest", renderDataRegistry.get("chest"), ChestGameObject::getItemCost, false, null);
        this.toolBox.addPart("distance_sensor", renderDataRegistry.get("distance_sensor"), DistanceSensorGameObject::getItemCost, false, null);
        this.toolBox.addPart("pid_controller", renderDataRegistry.get("pid_controller"), PIDControllerGameObject::getItemCost, false, null);
        this.toolBox.addPart("weight", renderDataRegistry.get("weight"), WeightGameObject::getItemCost, false, null);
        this.toolBox.addPart("rope", renderDataRegistry.get("rope"), RopeGameObject::getItemCost, false, null);
        this.toolBox.addPart("stick", renderDataRegistry.get("stick"), StickGameObject::getItemCost, false, null);
        this.toolBox.addPart("grabber", renderDataRegistry.get("grabber"), GrabberGameObject::getItemCost,false, null);
        this.toolBox.addPart("timer", renderDataRegistry.get("timer"), TimerGameObject::getItemCost, false, null);
        this.toolBox.addPart("piston", renderDataRegistry.get("piston_box"), PistonGameObject::getItemCost, false, "length");
        this.toolBox.addPart("spring", renderDataRegistry.get("spring"), SpringGameObject::getItemCost, false, null);
        this.toolBox.addPart("jet_engine", renderDataRegistry.get("jet_engine"), JetEngineGameObject::getItemCost, false, null);
        this.toolBox.addPart("flamethrower", renderDataRegistry.get("flamethrower"), FlamethrowerGameObject::getItemCost, false, null);
        this.toolBox.addPart("receiver", renderDataRegistry.get("receiver"), ReceiverGameObject::getItemCost, false, null);
        this.toolBox.addPart("transmitter", renderDataRegistry.get("transmitter"), TransmitterGameObject::getItemCost, false, null);
        this.toolBox.addPart("stabilizer", renderDataRegistry.get("stabilizer"), StabilizerGameObject::getItemCost, false, null);
        this.toolBox.addPart("pin", renderDataRegistry.get("pin"), StabilizerGameObject::getItemCost, false, null);
