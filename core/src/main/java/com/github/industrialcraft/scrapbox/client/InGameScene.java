...
public class InGameScene implements IScene {
    ...
    public void create() {
        ...
        this.toolBox.addPart("frame", renderDataRegistry.get("frame"), FrameGameObject::getItemCost, GameObject.GameObjectConfig.Property.OMaterial);
        this.toolBox.addPart("wheel", renderDataRegistry.get("wheel"), SimpleWheelGameObject::getItemCost, GameObject.GameObjectConfig.Property.OMaterial, GameObject.GameObjectConfig.Property.Size);
        this.toolBox.addPart("sticky_wheel", renderDataRegistry.get("sticky_wheel"), StickyWheelGameObject::getItemCost, GameObject.GameObjectConfig.Property.OMaterial, GameObject.GameObjectConfig.Property.Size);
        this.toolBox.addPart("cutting_wheel", renderDataRegistry.get("cutting_wheel"), CuttingWheelGameObject::getItemCost, GameObject.GameObjectConfig.Property.OMaterial, GameObject.GameObjectConfig.Property.Size);
        this.toolBox.addPart("motor", renderDataRegistry.get("motor"), MotorGameObject::getItemCost);
        this.toolBox.addPart("triangle", renderDataRegistry.get("triangle"), TriangleGameObject::getItemCost, GameObject.GameObjectConfig.Property.Size);
        this.toolBox.addPart("balloon", renderDataRegistry.get("balloon"), BalloonGameObject::getItemCost);
        this.toolBox.addPart("controller", renderDataRegistry.get("controller"), ControllerGameObject::getItemCost);
        this.toolBox.addPart("puncher", renderDataRegistry.get("puncher_box"), PunchBoxGameObject::getItemCost);
        this.toolBox.addPart("propeller", renderDataRegistry.get("propeller"), PropellerGameObject::getItemCost);
        this.toolBox.addPart("tnt", renderDataRegistry.get("tnt"), TntGameObject::getItemCost);
        this.toolBox.addPart("rotator", renderDataRegistry.get("rotator_join"), RotatorGameObject::getItemCost);
        this.toolBox.addPart("cannon", renderDataRegistry.get("cannon"), CannonGameObject::getItemCost);
        this.toolBox.addPart("position_sensor", renderDataRegistry.get("position_sensor"), PositionSensorGameObject::getItemCost);
        this.toolBox.addPart("display", renderDataRegistry.get("display"), DisplayGameObject::getItemCost);
        this.toolBox.addPart("math_unit", renderDataRegistry.get("math_unit"), MathUnitGameObject::getItemCost);
        this.toolBox.addPart("chest", renderDataRegistry.get("chest"), ChestGameObject::getItemCost);
        this.toolBox.addPart("distance_sensor", renderDataRegistry.get("distance_sensor"), DistanceSensorGameObject::getItemCost);
        this.toolBox.addPart("pid_controller", renderDataRegistry.get("pid_controller"), PIDControllerGameObject::getItemCost);
        this.toolBox.addPart("weight", renderDataRegistry.get("weight"), WeightGameObject::getItemCost);
        this.toolBox.addPart("rope", renderDataRegistry.get("rope"), RopeGameObject::getItemCost);
        this.toolBox.addPart("stick", renderDataRegistry.get("stick"), StickGameObject::getItemCost);
        this.toolBox.addPart("grabber", renderDataRegistry.get("grabber"), GrabberGameObject::getItemCost);
        this.toolBox.addPart("timer", renderDataRegistry.get("timer"), TimerGameObject::getItemCost);
        this.toolBox.addPart("piston", renderDataRegistry.get("piston_box"), PistonGameObject::getItemCost, GameObject.GameObjectConfig.Property.Size);
        this.toolBox.addPart("spring", renderDataRegistry.get("spring"), SpringGameObject::getItemCost);
        this.toolBox.addPart("jet_engine", renderDataRegistry.get("jet_engine"), JetEngineGameObject::getItemCost);
        this.toolBox.addPart("flamethrower", renderDataRegistry.get("flamethrower"), FlamethrowerGameObject::getItemCost);
        this.toolBox.addPart("receiver", renderDataRegistry.get("receiver"), ReceiverGameObject::getItemCost);
        this.toolBox.addPart("transmitter", renderDataRegistry.get("transmitter"), TransmitterGameObject::getItemCost);
        this.toolBox.addPart("stabilizer", renderDataRegistry.get("stabilizer"), StabilizerGameObject::getItemCost);
        this.toolBox.addPart("pin", renderDataRegistry.get("pin"), StabilizerGameObject::getItemCost);
