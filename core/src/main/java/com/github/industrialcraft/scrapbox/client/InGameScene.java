...
public class InGameScene implements IScene {
    ...
    public void create() {
        ...
        this.toolBox.addPart("frame", renderDataRegistry.get("frame"), FrameGameObject::getItemCost, true, false, false);
        this.toolBox.addPart("wheel", renderDataRegistry.get("wheel"), SimpleWheelGameObject::getItemCost, true, true, false);
        this.toolBox.addPart("sticky_wheel", renderDataRegistry.get("sticky_wheel"), StickyWheelGameObject::getItemCost, true, true, false);
        this.toolBox.addPart("cutting_wheel", renderDataRegistry.get("cutting_wheel"), CuttingWheelGameObject::getItemCost, true, true, false);
        this.toolBox.addPart("motor", renderDataRegistry.get("motor"), MotorGameObject::getItemCost, false, false, false);
        this.toolBox.addPart("triangle", renderDataRegistry.get("triangle"), TriangleGameObject::getItemCost, false, false, true);
        this.toolBox.addPart("balloon", renderDataRegistry.get("balloon"), BalloonGameObject::getItemCost, false, false, false);
        this.toolBox.addPart("controller", renderDataRegistry.get("controller"), ControllerGameObject::getItemCost, false, false, false);
        this.toolBox.addPart("puncher", renderDataRegistry.get("puncher_box"), PunchBoxGameObject::getItemCost, false, false, false);
        this.toolBox.addPart("propeller", renderDataRegistry.get("propeller"), PropellerGameObject::getItemCost, false, false, false);
        this.toolBox.addPart("tnt", renderDataRegistry.get("tnt"), TntGameObject::getItemCost, false, false, false);
        this.toolBox.addPart("rotator", renderDataRegistry.get("rotator_join"), RotatorGameObject::getItemCost, false, false, false);
        this.toolBox.addPart("cannon", renderDataRegistry.get("cannon"), CannonGameObject::getItemCost, false, false, false);
        this.toolBox.addPart("position_sensor", renderDataRegistry.get("position_sensor"), PositionSensorGameObject::getItemCost, false, false, false);
        this.toolBox.addPart("display", renderDataRegistry.get("display"), DisplayGameObject::getItemCost, false, false, false);
        this.toolBox.addPart("math_unit", renderDataRegistry.get("math_unit"), MathUnitGameObject::getItemCost, false, false, false);
        this.toolBox.addPart("chest", renderDataRegistry.get("chest"), ChestGameObject::getItemCost, false, false, false);
        this.toolBox.addPart("distance_sensor", renderDataRegistry.get("distance_sensor"), DistanceSensorGameObject::getItemCost, false, false, false);
        this.toolBox.addPart("pid_controller", renderDataRegistry.get("pid_controller"), PIDControllerGameObject::getItemCost, false, false, false);
        this.toolBox.addPart("weight", renderDataRegistry.get("weight"), WeightGameObject::getItemCost, false, false, false);
        this.toolBox.addPart("rope", renderDataRegistry.get("rope"), RopeGameObject::getItemCost, false, false, false);
        this.toolBox.addPart("stick", renderDataRegistry.get("stick"), StickGameObject::getItemCost, false, false, false);
        this.toolBox.addPart("grabber", renderDataRegistry.get("grabber"), GrabberGameObject::getItemCost,false, false, false);
        this.toolBox.addPart("timer", renderDataRegistry.get("timer"), TimerGameObject::getItemCost, false, false, false);
        this.toolBox.addPart("piston", renderDataRegistry.get("piston_box"), PistonGameObject::getItemCost, false, false, false);
        this.toolBox.addPart("spring", renderDataRegistry.get("spring"), SpringGameObject::getItemCost, false, false, false);
        this.toolBox.addPart("jet_engine", renderDataRegistry.get("jet_engine"), JetEngineGameObject::getItemCost, false, false, false);
