...
public enum Material {
    Wood(0, 0.8f, 1, true, new Color(120 / 255f, 60 / 255f, 6 / 255f, 1)),
    Metal(1, 1.5f, 3, false, new Color(117 / 255f, 117 / 255f, 117 / 255f, 1));
    public final byte id;
    public final float density;
    public final float baseHealthMultiplier;
    public final boolean flammable;
    public final Color color;
    Material(int id, float density, float baseHealthMultiplier, boolean flammable, Color color) {
        this.id = (byte) id;
