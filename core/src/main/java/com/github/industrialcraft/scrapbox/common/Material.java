...
public enum Material {
    Wood(0, "Wood", 0.8f, 1, true, new Color(120 / 255f, 60 / 255f, 6 / 255f, 1), EItemType.Wood),
    Metal(1, "Metal", 1.5f, 3, false, new Color(117 / 255f, 117 / 255f, 117 / 255f, 1), EItemType.Metal);
    ...
    Material(int id, String name, float density, float baseHealthMultiplier, boolean flammable, Color color, EItemType materialItem) {
        this.id = (byte) id;
        this.name = name;
